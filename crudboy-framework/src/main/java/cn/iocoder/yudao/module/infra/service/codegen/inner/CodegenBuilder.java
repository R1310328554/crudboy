...
import com.luokup.util.GenerateSqlUtil;
...
public class CodegenBuilder {
    ...
    private static final Map<String, CodegenColumnHtmlTypeEnum> COLUMN_HTML_TYPE_MAPPINGS =
            MapUtil.<String, CodegenColumnHtmlTypeEnum>builder()
                    ...
                    .put("ret", CodegenColumnHtmlTypeEnum.RADIO)
    ...
    static {
        ...
        LIST_OPERATION_RESULT_EXCLUDE_COLUMN.remove("creator"); // 创建时间，还是需要返回的
        LIST_OPERATION_RESULT_EXCLUDE_COLUMN.remove("updateTime"); // 创建时间，还是需要返回的
        LIST_OPERATION_RESULT_EXCLUDE_COLUMN.remove("updater"); // 创建时间，还是需要返回的
    }
