...
//        ret = genCategory(dir);
     ...
     * @param comment
     */
    private static List<String > genDict(final String fieldName0, final String comment) {
//        String comment = "应急避难种类|||☑ 地震 □台风 ☑ 洪水 ☑ 地质灾害 ☑ 火灾（含森林火灾） □其他灾害(自然灾害) □综合灾害(自然灾害) □事故灾难 □其他突发事件（突发公共卫生事 件、社会安全事件）";
        ...
        if (fieldAndComments.length > 1) {
            ...
            System.out.println("准备创建数据字典 = " + comment);
...
//                break;
    ...
    private static TableEntity readExcel(File file) {
        ...
        for (int j = 0; j < tableFields.size(); j++) {
           ExcelEntity entity = tableFields.get(j);
            String filedName = entity.getFiledName();

            String filedType = entity.getFiledType();
//          System.out.println(filedName + " = " + filedType);
           ...
           ExcelEntity entity2 = Chinese2VariableNameUtil.str2Field(filedNameUnified);
            entity.setAttribute(entity2.getAttribute());
            entity.setNotes(filedName);
            entity.setRequired(entity2.getRequired());
...
//                filedName2 += 2;
            ...
            entity.setFiledName(filedName2);

            if (filedType.equalsIgnoreCase("BLANK") ||
                    filedType.equalsIgnoreCase("STRING")) {
                entity.setFiledType(entity2.getFiledType());
            } else {
            ...
            for (int i = 0; i < size; i++) {
               ExcelEntity entity = fields.get(i);
                ...
                if (filedName.equalsIgnoreCase("id")) {
                    ...
                    sb.append(" CHARACTER SET utf8mb4 "); //字符串、文本设置编码
                }
...
// 数据 展示  2305
            ...
            if(!allFields.contains("name")) {
                sb.append("  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '名称',\n");
                // todo 如果不存在 name ，但是存在 unit_name 或者  survey_name， 那么把这个名字改为 name ？？
            }
            if(!allFields.contains("code")) {
                sb.append("  `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '编码',\n");
            }
            if(!allFields.contains("address")) {
                sb.append("  `address` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '地址',\n");
            }
//            if(!allFields.contains("province")) {
//                sb.append("  `province` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '省',\n");
//            }
//            if(!allFields.contains("city")) {
//                sb.append("  `city` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '市',\n");
//            }
//            if(!allFields.contains("county")) {
//                sb.append("  `county` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '县',\n");
//            }
//            if(!allFields.contains("district")) {
//                sb.append("  `district` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '区',\n");
//            }
//            if(!allFields.contains("village")) {
//                sb.append("  `village` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '村',\n");
//            }
//            if(!allFields.contains("region")) {
//                sb.append("  `region` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '区域',\n");
//            }
//            if(!allFields.contains("town")) {
//                sb.append("  `town` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '乡镇',\n");
//            }
            if(!allFields.contains("contact") && !allFields.contains("phone")) { // 不就是电话吗？
                sb.append("  `contact` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '联系方式',\n");
            }
//            if(!allFields.contains("phone")) { // 不就是电话吗？
//                sb.append("  `phone` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '电话',\n");
//            }
            if(!allFields.contains("status")) {
                sb.append("  `status` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '数据状态',\n");
            }
            if(!allFields.contains("data_source")) {
                sb.append("  `data_source` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '数据来源',\n");
            }

            if(!allFields.contains("survey_man")) {
                sb.append("  `survey_man` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '调查人',\n");
            }

//            if(!allFields.contains("unit")) {
//                sb.append("  `unit` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '调查单位',\n");
//            }
            if(!allFields.contains("survey_unit") && !allFields.contains("unit")) { // ??? 是否可以统一？？
                sb.append("  `survey_unit` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '调查单位',\n");
            }
            ...
            if(!allFields.contains("audit_man")) {
                sb.append("  `audit_man` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '核查人',\n");
            }
            if(!allFields.contains("audit_ret")) {
                sb.append("  `audit_ret` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '核查结果',\n");
            }

            sb.append("" +
//                    "  `investigate_id` bigint NULL DEFAULT 0 COMMENT '调查人id',\n" +
                    "  `survey_man_id` bigint NULL DEFAULT 0 COMMENT '调查人id" + MARK + "',\n" + // todo
//                    "  `survey_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '调查人',\n" +
//                    "  `survey_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '调查时间',\n" +

//                    "  `rectify_man_id` bigint NULL DEFAULT 0 COMMENT '整改人id',\n" +
//                    "  `rectify_man` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '整改人',\n" +
//                    "  `rectify_ret` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '整改结果',\n" +
//                    "  `rectify_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '整改时间',\n" +

//                    "  `qac_man_id` bigint NULL DEFAULT 0 COMMENT '质检人id',\n" +
//                    "  `qac_ret` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '质检结果',\n" +
//                    "  `qac_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '质检时间',\n" +

                    "  `audit_man_id` bigint NULL DEFAULT 0 COMMENT '核查人id',\n" +
//                    "  `audit_man` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '核查人',\n" +
//                    "  `audit_ret` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '核查结果',\n" +
//                    "  `audit_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '核查时间',\n" +

//                    "  `status` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '状态',\n" +
